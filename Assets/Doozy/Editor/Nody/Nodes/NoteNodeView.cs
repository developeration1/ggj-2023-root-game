...
{
    public class NoteNodeView : FlowNodeView
    {
        public override Type nodeType => typeof(NoteNode);
        ...
        public NoteNodeView(FlowGraphView graphView, FlowNode node) : base(graphView, node)
        {
